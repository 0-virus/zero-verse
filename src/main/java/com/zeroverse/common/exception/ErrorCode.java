...
public enum ErrorCode {
    ...
    INVALID_CREDENTIALS(HttpStatus.BAD_REQUEST, "AUTH_003", "이메일 또는 비밀번호가 올바르지 않습니다."),
    ...
    WRONG_PASSWORD(HttpStatus.UNAUTHORIZED, "USER_002", "현재 비밀번호가 올바르지 않습니다."),

    // Blog
    BLOG_NOT_FOUND(HttpStatus.NOT_FOUND, "BLOG_001", "존재하지 않는 블로그입니다."),
    DUPLICATE_URL_SLUG(HttpStatus.CONFLICT, "BLOG_002", "이미 사용 중인 블로그 주소입니다."),
    ...
    CATEGORY_DEPTH_EXCEEDED(HttpStatus.BAD_REQUEST, "CAT_002", "카테고리는 최대 1단계까지만 가능합니다."),

    // Comment
    COMMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "CMT_001", "존재하지 않는 댓글입니다."),
    COMMENT_DEPTH_EXCEEDED(HttpStatus.BAD_REQUEST, "CMT_002", "대댓글에는 댓글을 달 수 없습니다."),
